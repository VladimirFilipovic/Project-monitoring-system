...
namespace ITSolutionsCompanyV1.Migrations
{
    ...
    [Migration("20210506121542_unique")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITSolutionsCompanyV1.Models.Client", b =>
                {
                    ...
                    b.HasIndex("CompanyName", "Pib")
                        .IsUnique()
                        .HasFilter("[CompanyName] IS NOT NULL AND [Pib] IS NOT NULL");
            ...
            modelBuilder.Entity("ITSolutionsCompanyV1.Models.Project", b =>
                {
                    b.HasOne("ITSolutionsCompanyV1.Models.Request", "Request")
                        .WithOne("Project")
                        .HasForeignKey("ITSolutionsCompanyV1.Models.Project", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
