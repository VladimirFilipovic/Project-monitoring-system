        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountIsActive = table.Column<bool>(nullable: true, defaultValue: true),
                    UserImage = table.Column<byte[]>(maxLength: 10485760, nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    CompanyName = table.Column<string>(maxLength: 300, nullable: true),
                    Pib = table.Column<string>(maxLength: 8, nullable: true),
                    Salary = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StartDateOfContract = table.Column<DateTime>(nullable: true, defaultValueSql: "getdate()"),
                    EndDateOfContract = table.Column<DateTime>(nullable: true),
                    NumberOfActiveProjects = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pdf = table.Column<byte[]>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateSent = table.Column<DateTime>(nullable: true, defaultValueSql: "getdate()"),
                    Accepted = table.Column<bool>(nullable: true, defaultValue: false),
                    Specification = table.Column<byte[]>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 200, nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false, defaultValueSql: "getdate()"),
                    Video = table.Column<byte[]>(nullable: false),
                    Exe = table.Column<byte[]>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Demos_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(nullable: false),
                    RoleOnProject = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(nullable: false, defaultValue: "EUR"),
                    ClientId = table.Column<Guid>(nullable: false),
                    ProjectId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeTask_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
